...
<form action="{{route('movie.update',$movies->id)}}" method="post" enctype="multipart/form-data">
    ...
    <div class="card-body">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="title" id="exampleInputEmail1" placeholder="Enter movie title" class="@error('title') is-invalid @enderror" value="{{$movies->title}}">
            @error('title')
